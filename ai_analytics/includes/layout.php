...
<head>
  ...
  <link href="assets/index-custom.css?v=<?= filemtime(__DIR__ . '/../assets/index-custom.css') ?>" rel="stylesheet">
  <link href="assets/enhancements.css?v=<?= filemtime(__DIR__ . '/../assets/enhancements.css') ?>" rel="stylesheet">
...
<body>
<!-- Глобальный индикатор загрузки страницы -->
<div id="page-loader" style="position:fixed;top:0;left:0;right:0;bottom:0;background:#f5f5f5;display:flex;align-items:center;justify-content:center;z-index:9999;transition:opacity 0.3s;">
  <div style="text-align:center;">
    ...
    <div style="margin-top:16px;color:#6b7280;font-size:14px;">Загрузка страницы...</div>
  </div>
</div>
