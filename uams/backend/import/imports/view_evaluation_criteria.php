...
<div class="container">
  ...
  <div class="mt-4">
    <a href="../import.php?import_tab=criteria" class="btn btn-primary">Back to Import</a>
    <a href="../../../ai_analytics/index.php" class="btn btn-outline-secondary">Back to Analytics</a>
  </div>
</div>
